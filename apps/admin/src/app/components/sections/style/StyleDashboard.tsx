...
export function StyleDashboard() {
  ...
  const [styleMode, setStyleMode] = useState<'editorial' | 'personal'>(
    'editorial'
  );
  ...
  const currentAuthor =
    authors.find(a => a.id === selectedAuthor) || authors[0];
            ...
            <Card className='mb-6'>
              <CardContent className='p-4'>
                <Tabs
                  value={styleMode}
                  onValueChange={value =>
                    setStyleMode(value as 'editorial' | 'personal')
                  }
                >
                      ...
                      {styleMode === 'personal' && (
                        <div className='flex items-center gap-2'>
                          ...
                          <Popover
                            ...
                            onOpenChange={setAuthorComboboxOpen}
                          >
              ...
              <div className='mt-6 pt-4 border-t flex items-center justify-between'>
                <div className='flex items-center gap-2 text-sm'>
                  ...
                  <span className='text-muted-foreground'>
                    Голос настроен • Последнее обновление:{' '}
                    {styleStats.lastUpdated}
                  </span>
                </div>
              </div>
            </CardContent>
                ...
                <CardContent className='p-6'>
                  <div className='flex items-start gap-4'>
                    ...
                    <div className='flex-1 min-w-0'>
                      ...
                      <p className='text-sm text-muted-foreground mb-3'>
                        Грамматика, форматирование, стилистика и стандарты
                        качеств
                      </p>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    <p className='text-sm text-muted-foreground mb-4'>
                      Автоматически сгенерированные инструкции на основе всех
                      настроек стиля
                    </p>
            ...
            <CardContent className='p-6'>
              <div className='flex gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Настройки стиля автоматически применяются во всех
                    инструментах работы с текстом. AI Center использует эти
                    правила для генерации контента, а редактор статей — для
                    проверки текстов.
                  </p>
                </div>
              </div>
