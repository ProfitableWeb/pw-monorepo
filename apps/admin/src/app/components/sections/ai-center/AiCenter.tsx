      ...
      <div className='flex-1 min-h-0'>
        <ScrollArea ref={scrollAreaRef} className='h-full'>
          <div className='max-w-4xl mx-auto space-y-6 p-6 pb-12'>
            {/* Увеличили padding-bottom с pb-6 до pb-12 */}
            {/* Пустое состояние для новой сессии */}
            {messages.length === 0 && !isStreaming && (
              <div className='flex flex-col items-center justify-center min-h-[60vh] text-center px-4'>
                ...
                <p className='text-muted-foreground mb-8 max-w-md'>
                  Используйте AI для написания статей, анализа данных, создания
                  контента и многого другого.
                </p>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl'>
                  <button
                    onClick={() =>
                      setInput(
                        'Помоги написать статью о новых трендах в веб-разработке'
                      )
                    }
                  ...
                  <button
                    onClick={() =>
                      setInput(
                        'Проанализируй текущие метрики блога и дай рекомендации'
                      )
                    }
                    className='group p-4 rounded-lg border bg-card hover:bg-accent transition-colors text-left'
                  >
                  ...
                  <button
                    onClick={() =>
                      setInput(
                        'Предложи темы для следующих публикаций на основе трендов'
                      )
                    }
                    className='group p-4 rounded-lg border bg-card hover:bg-accent transition-colors text-left'
                  >
                  ...
                  <button
                    onClick={() =>
                      setInput('Оптимизируй SEO для моих последних статей')
                    }
                    className='group p-4 rounded-lg border bg-card hover:bg-accent transition-colors text-left'
                  >
                    <div className='flex items-start gap-3'>
                ...
                >
                  ...
                  <DialogContent className='max-w-lg'>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Добавьте свой шаблон для быстрого доступа к часто
                        используемым промптам
                      </DialogDescription>
                    </DialogHeader>
