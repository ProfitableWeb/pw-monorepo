...
export function CalendarSettingsDialog({
  ...
  const sections = [
    ...
    {
      id: 'content-plan' as SettingsSection,
      label: 'Контент-план',
      icon: FileText,
    },
    {
              ...
              <div className='space-y-4'>
                <div className='grid gap-2'>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    Выберите режим, который будет открываться при загрузке
                    календаря
                  </p>
                </div>
          ...
          <div className='space-y-6'>
            <div>
              ...
              <div className='space-y-4'>
                ...
                <div className='grid gap-2'>
                  <Label htmlFor='suggestions-count'>
                ...
                <div className='grid gap-2'>
                  ...
                  />
                  <p className='text-xs text-muted-foreground'>
                    Укажите темы через запятую, которые интересуют вашу
                    аудиторию
                  </p>
                </div>
                    ...
                    {['Пн', 'Вт', 'Ср', 'Чт', 'Пт', 'Сб', 'Вс'].map(
                      (day, index) => (
                        <Button
                          key={day}
                          variant={
                            [1, 3, 5].includes(index) ? 'default' : 'outline'
                          }
                          size='sm'
                          className='flex-1'
                        >
