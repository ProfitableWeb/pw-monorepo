...
export const mockCategories: Category[] = [
  ...
  },
  {
    ...
    description:
      '<p>Искусственный интеллект открывает новые возможности для автоматизации. Мы разбираем практические сценарии применения ИИ в продуктовой разработке и бизнес-процессах.</p>',
    articleCount: 3,
  },
  {
    id: '3',
    ...
    description:
      '<p>Дизайн влияет на восприятие продукта и эффективность взаимодействия. Здесь собраны материалы о пользовательских исследованиях, прототипировании и визуальной системе.</p>',
    articleCount: 4,
  },
  {
    id: '4',
    ...
    description:
      '<p>Новые технологии меняют рынок и привычки людей. Мы обсуждаем сценарии будущего, влияние ИИ и перспективы цифровой экономики.</p>',
    articleCount: 2,
  },
  {
    id: '5',
    ...
    description:
      '<p>Контент-стратегия, редактура и стиль — ключ к доверию аудитории. Разбираем подходы к созданию сильных текстов и контентных систем.</p>',
    articleCount: 3,
  },
  {
    id: '6',
    ...
    description:
      '<p>От идеи до запуска: изучаем процессы создания цифровых продуктов, работу с метриками, итеративную разработку и подходы к валидации гипотез.</p>',
    articleCount: 4,
  },
];
